  ...
  <div class="contenedor">
    {#each juegosSVG as juego}
      <div class="juego-item">
        <div class="modulos">
          <!-- Renderizamos 10 SVGs horizontalmente -->
          {#each Array(10) as _}
...
<style>
  ...
  .contenedor {
    ...
    gap: 10px; /* Espacio entre cada fila de juegos */
    max-width: 1020px;
    margin: auto;
  }
  ...
  .modulos {
    display: flex; /* Los SVG se alinean horizontalmente */
    gap: 5px; /* Espacio entre SVGs */
  }

  .svg-wrapper {
    display: block;
    width: 40px; /* Ajuste de tamaño del SVG */
    height: 40px;
  }
