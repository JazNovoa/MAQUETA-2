...
<style>
  ...
  flex-direction: column; /* Alinear en columna (imagen arriba, texto abajo) */
  align-items: center; /* Centrar elementos horizontalmente */
  justify-content: center; /* Centrar elementos verticalmente (opcional si solo hay una fila) */
  margin-top: 30px; /* Espacio superior, ajusta según sea necesario */
  margin-bottom: 25px; /* Espacio inferior, ajusta según sea necesario */
}

.indice {
  width: 80%; /* Ancho de la imagen, ajusta según sea necesario */
  max-width: 500px; /* Opcional: establecer un ancho máximo */
}

.footer {
  font-size: 20px;
  text-align: center; /* Alinear texto al centro */
  margin-top: 15px; /* Espacio superior entre imagen y texto */
}
